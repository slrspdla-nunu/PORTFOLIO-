...
const PROJECTS = {
  ...
  'purrcare': {
    ...
    outcome: '가상 브랜드지만 콘셉트·무드·쇼핑 플로우가 하나로 이어지는, 따뜻하고 정돈된 커머스 사이트를 완성했습니다.',
  ...
  'local-community': {
    ...
    process: [
      ...
      { step: 'Build', desc: '게시판(목록·상세·작성·검색) 기능을 React Native로 직접 구현.' },
    ],
    decisions: [
      { title: '메인 디자인 담당', desc: '앱 전반의 톤·컴포넌트·핵심 화면을 설계해 팀 화면들의 일관성을 잡음.' },
      { title: '게시판 직접 구현', desc: '디자인과 함께 게시판(목록·상세·작성·검색) 기능을 코드로 구현.' },
      { title: '머무르게 하는 재미', desc: '마이룸·출석·레벨 등 게임 요소로 단순 정보 앱을 넘어 다시 찾을 동기를 부여.' },
      { title: '가벼운 참여', desc: '글쓰기·소통 단계를 줄여 혼자 사는 사용자도 부담 없이 참여하게 함.' },
    ],
    outcome: '동네 소통(게시판·채팅·모임)과 재미 요소(마이룸·레벨)를 갖춘 커뮤니티 앱을 팀으로 완성했고, 저는 메인 디자인과 게시판 구현을 맡았습니다.',
  ...
  'imagination-door': {
    ...
    process: [
      ...
      { step: 'Build', desc: '예약·예약확인 등 실제 예약 플로우를 팀에서 구현(백엔드 연동).' },
    ],
    decisions: [
    ...
    outcome: '정보 나열형이던 예약 사이트가 다크 무드의 몰입형 브랜드 경험으로 바뀌고, 테마 탐색부터 예약·확인까지 흐름이 또렷해졌습니다.',
  ...
  'wolfram-alpha': {
    ...
    decisions: [
      ...
      { title: '살아있는 사용감', desc: '"지금 N명이 풀고 있어요" 카운터와 예시 카드로 딱딱한 도구를 써보고 싶게 만듦.' },
    ],
    outcome: '검색·영문 위주의 딱딱한 첫인상이 한국어 친화적이고 따뜻한 탐색형 경험으로 바뀌고, "무엇을 물어볼 수 있는지"가 첫 화면에서 드러납니다.',
  ...
  'hogwarts': {
    ...
    outcome: '구매 유도 중심의 마케팅 랜딩을, 정보는 그대로 담으면서 세계관을 체험하는 몰입형 사이트로 리디자인했습니다. "분위기가 산다"는 피드백을 받으면서도 정보 전달은 유지했습니다.',
  ...
  'dream-diary': {
    ...
    outcome: '단순 일기를 넘어, 꿈을 모으고(도감) 패턴을 돌아보는(통계·지도) 흐름까지 갖춘 꿈일기 웹앱을 완성했습니다.',
  ...
  'altitude': {
    ...
    outcome: '가상 브랜드지만 콘셉트·무드·쇼핑 플로우가 하나로 이어지는, 실제 같은 커머스 사이트를 완성했습니다.',
