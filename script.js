...
function initHeroChat() {
  ...
  const A = [
    { t: '제작물을 보여주면서, 보는 사람이 지루하지 않게 만드는 것이 목표였습니다.' },
    { t: "그래서 정보를 단순하게 '보여주기'보다 스크롤마다 반응하는 무언가를 제작해 시선을 끌도록 하였습니다." },
    { k: 'About Me', t: '자기소개를 원이 퍼지며 여는 연출로 감쌌습니다. 흑백 + 픽셀 폰트로 절제된 개성을 먼저 보여주고 싶었습니다.' },
    { k: 'Skill', t: '우측엔 사용할 수 있는 툴을 소개하였고, 좌측엔 자신있는 역량을 따로 빼내어 게이지를 사용하였습니다. 보기에 직관적으로 표현하고 싶었습니다.' },
    { k: 'Selected Works', t: '대표작은 고정된 화면으로 진행되며, 영상이나 움직이는 물체를 사용하여 지루하지 않도록 하였습니다. 목업에 마우스를 대면 메인 페이지가 스크롤 됩니다.' },
    { k: 'Project Archive', t: '전체 작업물은 썸네일을 넣어 카드 형태로 제작하였습니다. 스크롤 하면 간단한 한줄 소개가 말풍선으로 뜹니다.' },
    { k: 'Graphic Design', t: '지금껏 작업했던 배너, 모바일 배너, 포스터를 보여주는 공간입니다. 양이 많은 배너는 슬라이드되며 보여주도록 하였고, 그 외의 것은 클릭하면 자세히 볼 수 있게 하였습니다.' },
    { k: 'Contact', t: "마지막엔 웃으며 끝나는 마무리를 주고 싶었습니다." },
    { t: '늘어놓지 않고 끝까지 보게 만드는 게 이 포트폴리오입니다 :)' },
  ];
